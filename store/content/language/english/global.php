...
$charset                   = 'utf-8'; // Main HTML character set..
$mail_charset              = 'utf-8'; // Email header character set..
...
$msg_script17              = 'Default cookie name must be changed in "<b>control/connect.php</b>" file..';
$msg_script18              = 'Default secret key must be changed in "<b>control/connect.php</b>" file..';
$msg_script19              = '';
...
$msg_script54              = 'System';
$msg_script55              = 'Find Us on Facebook';
...
$msg_javascript4           = 'Your main email address. For email notifications. This address also appears as the reply-to email address in emails.';
$msg_javascript5           = 'The url to your cart installation. NO trailing slash. Example:<br><br><b>http://www.example.com/cart</b><br><br>Replace the path with your own path and domain. The script will attempt to complete this on installation.';
...
$msg_javascript10          = 'Do you wish to enable the search engine friendly urls? Your server MUST support .htaccess and mod_rewrite.<br><br>Uncheck box not to show trailing "index.html" in urls.';
...
$msg_javascript13          = 'Enter your paypal business, premier or sandbox email address.';
...
$msg_javascript23          = 'Your SMTP username. Usually your email address. Check with your host if you aren`t sure.';
$msg_javascript24          = 'Your SMTP password.';
$msg_javascript25          = 'Enter SMTP port number. Usually 25 or 26. You may also be able to use the submission port, eg: 587. Check with your host if you aren`t sure.';
...
$msg_javascript50          = 'Specify the start weight. This can be any kind of weight band, but must match your product weight. For example, if your products are in grammes, use a gramme range. eg: 0 to 1000. No commas or period symbols.';
$msg_javascript51          = 'Specify the end weight. This can be any kind of weight band, but must match your product weight. For example, if your products are in grammes, use a gramme range. eg: 0 to 1000. No commas or period symbols.';
$msg_javascript52          = 'Specify the cost of shipping in this weight band. No currency symbol. eg: 9.99 (NO commas)';
...
$msg_javascript80          = 'Do you wish to enable low stock notification? When this product or any attribute associated with this product reaches a specified level, you will receive an email. Set to 0 for no notification. ';
$msg_javascript81          = 'Enter attribute name.';
$msg_javascript82          = 'Enter product weight. This can be any kind of weight band, but must match your product weight. For example, if your products are in grammes, use a gramme range. eg: 0 to 1000. No commas or period symbols.<br><br>For downloadable product, set to 0. If weight is entered and product is downloadable, this is ignored.';
$msg_javascript83          = 'Enter stock level. For a downloadable item, enter a really high amount. Max 9999999. Or set the system to not reduce stock on downloadable items on the global cart settings page.<br><br>By default the system will NOT reduce stock on downloadable items.';
...
$msg_javascript87          = 'Specify price adjustment. This can be a set amount or a percentage. eg: 9.99 or 10%. No currency symbol for price and NO commas. Note that for <b>fixed</b> adjustment type, price must be specified.';
...
$msg_javascript92          = 'Do you wish to omit prices between a certain range? Both prices must be set. No currency symbol. eg: 9.99. NO Commas';
$msg_javascript93          = 'Enter stock level adjustment amount. Must be integer. eg: 5,10,20';
...
$msg_javascript100         = 'Shipping Services';
...
$msg_javascript109         = 'Do you wish to enable the admin entry log? Can be a useful security feature. You can omit specified staff from being logged if you wish.';
$msg_javascript110         = 'If you have a related product video, specify the video file here. Video files must be uploaded into the <b>content/audio-video/</b> folder and be FLV (Flash Video) format ONLY!';
...
$msg_javascript115         = 'Error - A problem occurred updating your basket. Please wait a few moments and then try again..';
$msg_javascript116         = 'Please select a shipping zone/area in "{country}"<br><br>If yours is not listed, please contact us.';
...
$msg_javascript119         = '<span class="highlight">{region} / {country}</span> - Shipping Options. Please select your preferred option.';
...
$msg_javascript130         = 'Attach any file to this update. This is sent to the recipients mailbox along with the message as a standard email attachment.<br><br>Take into account that certain files are blocked by mail programs. PDF or ZIP format is recommended.';
...
$msg_javascript137         = 'Specify data separator. This is usually a comma, but can be any character type.';
...
$msg_javascript143         = 'Do you wish to log payment system responses? This can be useful for debugging problems. Log folder directory must exist and be writeable.<br><br>If the log folder doesn`t exist, the system will attempt to create it.';
...
$msg_javascript150         = 'The header includes the field names for each column. eg: invoice,product,price..etc<br><br>You can omit this during import if you wish.';
...
$msg_javascript153         = 'An error occurred creating this folder. Check the "admin/attachments/" directory exists and has write permissions then try again. If this persists, create the folder manually!';
...
$msg_javascript178         = 'Enter instructions to buyer for this payment method. This is shown to buyers in their confirmation email.<br><br>HTML is not recommended here unless you are using HTML formatted emails.';
...
$msg_javascript199         = 'Specify which folder to save images to for this product. Create new folders inside the "content/products" folder and give them write permissions.<br><br>Or click the button to add a new folder! Note that folders must be removed manually.';
$msg_javascript200         = 'Full server path to store folder. NO trailing slash. Examples:<br><br>/home/server_name/public_html/store (<b>Unix Server</b>)<br>C:/store (<b>Windows Server</b>)<br><br>This is NOT a http web path. The script will attempt to complete this on installation. Click "Auto" to auto fill path.';
$msg_javascript201         = 'An error occurred creating this folder. This folder may already exist.';
...
$msg_javascript220         = 'Products with 0 Qty will be removed from sales purchase when sale is updated.\n\nClick the undo icon to restore.';
$msg_javascript221         = 'Live payment url for Paypal. Unless updated by Paypal, this should NOT be changed.';
$msg_javascript222         = 'Sandbox payment url for Paypal. Unless updated by Paypal, this should NOT be changed.';
$msg_javascript223         = 'Set Paypal Locale below if required. This may be required if you want to force a language display when visitors switch to Paypal to pay. Example: <b>EN</b> = English.<br><br>Refer to Paypal for correct locale codes. This is optional.';
$msg_javascript224         = 'Live/test payment url for 2Checkout. Unless updated by 2Checkout, this should NOT be changed.';
$msg_javascript225         = 'Specify log folder directory name if logging payment system responses. This must be writeable. Max 50 chars.<br><br>If the log folder doesn`t exist, the system will attempt to create it.';
...
$msg_javascript230         = 'This option enables you to activate or de-activate emails. This can be useful if you are testing on localhost and don`t have a mail server installed. If set to "No", system will send no emails.<br><br><b>Important!</b> This should be set to "Yes" when store is live.';
$msg_javascript231         = 'Specify display preference on how the price should display in your store. Use {PRICE} for the pricing position. Examples:<br><br>&amp;amp;pound;{PRICE} - (For UK store)<br>{PRICE}&amp;amp;euro; - (For Euro based store)<br>&amp;amp;#036;{PRICE}AUD - (For Australian based store)<br>&amp;amp;#036;{PRICE} - (For US store)<br><br>&amp;amp;pound; = &amp;pound;<br>&amp;amp;euro; = &amp;euro;<br>&amp;amp;#036; = &amp;#036;<br><br>Character entities (as shown above) should be used or just static text, eg: GBP{PRICE}<br><br>Rate is the equivalent to 1 of your base currency.';
...
$msg_javascript237         = 'Specify your store timezone. The system will attempt to determine your server timezone on install. Adjust if your store is in a different timezone.';
...
$msg_javascript247         = 'Do you want to pad invoice numbers with zeros? Invoice numbers correspond to database sale ids. The first sale will be 1, but you might want to specify the invoice as 000001. Set to 0 for invoice numbers to have no additional prefixed zeros or specify amount to add.<br><br>"Next Invoice No" will usually be 1 for most stores, but enter custom number if you want invoices to start at a specific number.';
$msg_javascript248         = 'Do you want to save this update?<br><br>Click "Yes" to update and create edit status or "No" to manually updated later.';
$msg_javascript249         = 'If you wish to copy this update to other email addresses, enter addresses separated with a comma. Example:<br><br><b>email@email.com,email2@email.com</b><br><br>Leave blank for no copies. If addresses are entered, the system will remember your selections for next time.';
$msg_javascript250         = '';
$msg_javascript251         = '';
$msg_javascript252         = '';
$msg_javascript253         = 'Payment Method:';
$msg_javascript254         = 'Staff Management';
...
$msg_javascript256         = 'Url is optional. If specified, banner is clickable. This can be an internal or external site url. Examples:<br><br><b>http://www.somesite.com</b> (External to another site)<br><br><b>?pd=4</b> (Internal to store product page)<br><br><b>?c=9</b> (Internal to store category page)<br><br><b>http://www.example.com/cart/?pd=4</b> (Also internal to store product page)';
$msg_javascript257         = 'Error, please select a group..';
$msg_javascript258         = 'Banner caption appears below the image. Leave blank for no caption.';
...
$msg_javascript261         = 'Specify staff type. Adminstrators have FULL admin access. Restricted staff can only access specified pages.';
$msg_javascript262         = 'If staff is restricted, specify the pages they have access to. At least 1 page must be specified. Note that the "Staff Management" page is not accessible by default for restricted staff.';
$msg_javascript263         = 'Does this staff member have delete privileges? If yes, any page they have access to will show delete options. If no, this staff member cannot execute deletions.';
$msg_javascript264         = 'Enable or disable this staff member. Disabled staff cannot access the system. Useful if you need to disable staff without deleting them.';
$msg_javascript265         = 'Login';
$msg_javascript266         = 'Price Points';
$msg_javascript267         = 'Clear ALL log..\n\nAre you sure?';
$msg_javascript268         = 'Clear entry log..\n\nAre you sure?';
$msg_javascript269         = 'Enter Start Price. No currency symbol for price and NO commas. eg:<br><br><b>2.99</b>';
$msg_javascript270         = 'Enter End Price. No currency symbol for price and NO commas. eg:<br><br><b>2.99</b>';
...
$msg_javascript281         = 'Folder name for additional zip files. By default located at "<b>content/additional-zip</b>". Any files included in this folder will be added to zip file downloads.<br><br>If you wish to call this folder something else, specify new name here and rename folder manually. Folder must exist in "<b>content</b>" directory.';
$msg_javascript282         = 'If you want the system to send emails to additional email addresses, enter them here. Separate multiple addresses with a comma.<br><br>If an email is sent to the main email address it will also copy to these addresses.';
...
$msg_javascript292         = 'Live/test payment url for Skrill. Unless updated by Skrill, this should NOT be changed.';
$msg_javascript293         = 'Enter your Skrill merchant account email address.';
$msg_javascript294         = 'Secret word as set in Skrill account area.';
$msg_javascript295         = 'Select Skrill language. Add additional languages to "admin/control/arrays.php" if supported.';
...
$msg_javascript298         = 'Instructions for visitor. For example, if you are selling products that can be personalised with someones name, the instructions might be:<br><br><b>Enter Your Name</b><br><br>You can also specify an alternative text to display in emails and on order pages, this is a second parameter separated with a pipe. Example:<br><br><b>Enter Your Name|Name</b><br><br>If the second parameter isn`t used, the main text is used.';
...
$msg_javascript310         = 'Please enter valid email address..';
$msg_javascript311         = 'Email Address Updated!';
$msg_javascript312         = 'Please enter valid email address..';
$msg_javascript313         = 'Email address already exists in our database, thank you!';
...
$msg_javascript336         = 'Live payment url for Google Checkout. Unless updated by Google, this should NOT be changed. With slash at the end.';
$msg_javascript337         = 'Sandbox payment url for Google Checkout. Unless updated by Google, this should NOT be changed. With slash at the end.';
...
$msg_javascript363         = 'Sorry, to purchase FREE items you must purchase at least {count} paid item(s).<br><br>Please adjust quantities or add other items to basket, thank you.';
...
$msg_javascript377         = 'Specify which folder to save main image to for this product. Create new folders inside the "content/products" folder and give them write permissions.<br><br>Or click the button to add a new folder! Note that folders must be removed manually.';
...
$msg_javascript387         = 'HTML version of email message. Default html template located in "admin/templates/language/{lang}/default-newsletter/" folder.<br><br>{unsubscribe} = Use this to auto create an unsubscribe option in your message';
$msg_javascript388         = 'Plain text version of above message. No formatting here, just plain text. Default plain text template located in "admin/templates/language/{lang}/default-newsletter/" folder.<br><br>{unsubscribe} = Use this to auto create an unsubscribe option in your message';
...
$msg_javascript391         = 'Enter 3 character country ISO code. eg: GBR, USA etc';
...
$msg_javascript394         = 'Do you wish to download a copy of this backup to your hard drive? This envokes the save-as dialogue box. If you set this as no and enter no email addresses, this is default.';
$msg_javascript395         = 'Do you wish to compress the backup file? This is recommended for large databases.';
$msg_javascript396         = 'Do you want to copy the backup to other email accounts? Email accounts should not be located on the same server. Add multiple emails if required separated with a comma.<br><br><b>SMTP must be enabled to send attachments. If its not this will be ignored.</b>';
...
$msg_javascript415         = 'Sorry, we only currently have the following stock:<br><br><b>{attribute}</b> ({count} available).';
...
$msg_javascript418         = 'Do you want this page to be set as the new landing page? If yes, when a visitor clicks to go to the store homepage, this page displays instead.<br><br>Only one page can be set as the landing page for none trade and trade accounts, so if a previous page was set, this will be unset. Leave as "no" to load default store homepage.<br><br>Ignored if page is set as an external link.';
...
$msg_javascript438         = 'Flat Rates';
$msg_javascript439         = 'Percentage Rates';
$msg_javascript440         = 'Weight Based';
$msg_javascript441         = 'Specify which zones this rate applies to';
$msg_javascript442         = 'Enter new flat rate. No commas or period symbols. eg: 9.99';
$msg_javascript443         = 'Do you want to enable this rate?';
$msg_javascript444         = 'Specify cost range for this rate. No commas or period symbols. eg: 9.99';
$msg_javascript445         = 'Specify percentage to apply if cost of goods is between above range. NO percentage symbol, eg: 5, 10';
...
$msg_javascript447         = 'Specify which rates to adjust:<br><br><b>Flat Rates</b> - Flat rates for selected zone(s)<br><b>Per Item Rates</b> - Per item rates for selected zone(s)<br><b>Percentage Rates</b> - Percentage based rates for selected zone(s)<br><b>Weight Based Rates</b> - Weight based rates for selected zone(s)<br><b>Tare Weight Rates</b> - Tare weight based rates<br><br>At least 1 option MUST be specified. If none are specified, defaults to weight based ONLY.';
...
$msg_javascript455         = 'Error. The minimum purchase quantity for this product is <b>{min}</b>.<br><br>Click the relevant button to view product and adjust quantity.';
